...
public class ShipmentServiceImpl implements ShipmentService {
    ...
    public ShipmentServiceImpl(ShipmentRepository shipmentRepository, FreightOrderRepository freightOrderRepository, DeliveryEventRepository deliveryEventRepository) {
