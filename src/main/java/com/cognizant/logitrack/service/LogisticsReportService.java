...
@Service
public class LogisticsReportService {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(LogisticsReportService.class);
    private final LogisticsReportRepository reportRepository;
    private final AuditLogRepository auditLogRepository;

    public LogisticsReportService(LogisticsReportRepository reportRepository, AuditLogRepository auditLogRepository) {
