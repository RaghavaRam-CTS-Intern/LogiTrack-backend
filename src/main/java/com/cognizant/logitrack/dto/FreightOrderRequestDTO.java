...
public class FreightOrderRequestDTO {
    @NotNull
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof FreightOrderRequestDTO)) return false;
        final FreightOrderRequestDTO other = (FreightOrderRequestDTO) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof FreightOrderRequestDTO;
    }
    ...
    public java.lang.String toString() {
        return "FreightOrderRequestDTO(shipperId=" + this.getShipperId() + ", originLocationId=" + this.getOriginLocationId() + ", destinationLocationId=" + this.getDestinationLocationId() + ", cargoDescription=" + this.getCargoDescription() + ", weight=" + this.getWeight() + ", volume=" + this.getVolume() + ", requiredDeliveryDate=" + this.getRequiredDeliveryDate() + ")";
    }

    public FreightOrderRequestDTO() {
    }

    public FreightOrderRequestDTO(final Integer shipperId, final Integer originLocationId, final Integer destinationLocationId, final String cargoDescription, final BigDecimal weight, final BigDecimal volume, final LocalDate requiredDeliveryDate) {
        this.shipperId = shipperId;
        this.originLocationId = originLocationId;
        this.destinationLocationId = destinationLocationId;
        this.cargoDescription = cargoDescription;
