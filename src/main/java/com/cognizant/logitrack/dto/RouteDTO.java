...
public class RouteDTO {
    ...
    public static class RouteDTOBuilder {
         ...
         * @return {@code this}.
         */
        public RouteDTO.RouteDTOBuilder routeId(final Integer routeId) {
         ...
         * @return {@code this}.
         */
        public RouteDTO.RouteDTOBuilder originHubId(final Integer originHubId) {
         ...
         * @return {@code this}.
         */
        public RouteDTO.RouteDTOBuilder destinationHubId(final Integer destinationHubId) {
         ...
         * @return {@code this}.
         */
        public RouteDTO.RouteDTOBuilder transitDays(final Integer transitDays) {
         ...
         * @return {@code this}.
         */
        public RouteDTO.RouteDTOBuilder mode(final RouteMode mode) {
            this.mode = mode;
            return this;
        }
         ...
         * @return {@code this}.
         */
        public RouteDTO.RouteDTOBuilder status(final RouteStatus status) {
            this.status = status;
            return this;
        }

        public RouteDTO build() {
            return new RouteDTO(this.routeId, this.originHubId, this.destinationHubId, this.transitDays, this.mode, this.status);
        }

        @java.lang.Override
        public java.lang.String toString() {
            return "RouteDTO.RouteDTOBuilder(routeId=" + this.routeId + ", originHubId=" + this.originHubId + ", destinationHubId=" + this.destinationHubId + ", transitDays=" + this.transitDays + ", mode=" + this.mode + ", status=" + this.status + ")";
        }
    }

    public static RouteDTO.RouteDTOBuilder builder() {
        return new RouteDTO.RouteDTOBuilder();
    }
    ...
    @java.lang.Override
    public java.lang.String toString() {
        return "RouteDTO(routeId=" + this.getRouteId() + ", originHubId=" + this.getOriginHubId() + ", destinationHubId=" + this.getDestinationHubId() + ", transitDays=" + this.getTransitDays() + ", mode=" + this.getMode() + ", status=" + this.getStatus() + ")";
    }

    public RouteDTO() {
    }

    public RouteDTO(final Integer routeId, final Integer originHubId, final Integer destinationHubId, final Integer transitDays, final RouteMode mode, final RouteStatus status) {
        this.routeId = routeId;
        this.originHubId = originHubId;
        this.destinationHubId = destinationHubId;
        this.transitDays = transitDays;
