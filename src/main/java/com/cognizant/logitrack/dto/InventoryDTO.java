...
public class InventoryDTO {
    ...
    public static class InventoryDTOBuilder {
         ...
         * @return {@code this}.
         */
        public InventoryDTO.InventoryDTOBuilder inventoryId(final Integer inventoryId) {
         ...
         * @return {@code this}.
         */
        public InventoryDTO.InventoryDTOBuilder sku(final String sku) {
            this.sku = sku;
            return this;
        }
         ...
         * @return {@code this}.
         */
        public InventoryDTO.InventoryDTOBuilder productName(final String productName) {
         ...
         * @return {@code this}.
         */
        public InventoryDTO.InventoryDTOBuilder warehouseId(final Integer warehouseId) {
         ...
         * @return {@code this}.
         */
        public InventoryDTO.InventoryDTOBuilder binLocation(final String binLocation) {
         ...
         * @return {@code this}.
         */
        public InventoryDTO.InventoryDTOBuilder quantityOnHand(final Integer quantityOnHand) {
         ...
         * @return {@code this}.
         */
        public InventoryDTO.InventoryDTOBuilder quantityReserved(final Integer quantityReserved) {
         ...
         * @return {@code this}.
         */
        public InventoryDTO.InventoryDTOBuilder lastUpdated(final LocalDateTime lastUpdated) {
            this.lastUpdated = lastUpdated;
            return this;
        }

        public InventoryDTO build() {
            return new InventoryDTO(this.inventoryId, this.sku, this.productName, this.warehouseId, this.binLocation, this.quantityOnHand, this.quantityReserved, this.lastUpdated);
        }

        @java.lang.Override
        public java.lang.String toString() {
            return "InventoryDTO.InventoryDTOBuilder(inventoryId=" + this.inventoryId + ", sku=" + this.sku + ", productName=" + this.productName + ", warehouseId=" + this.warehouseId + ", binLocation=" + this.binLocation + ", quantityOnHand=" + this.quantityOnHand + ", quantityReserved=" + this.quantityReserved + ", lastUpdated=" + this.lastUpdated + ")";
        }
    }

    public static InventoryDTO.InventoryDTOBuilder builder() {
    ...
    @java.lang.Override
    public java.lang.String toString() {
        return "InventoryDTO(inventoryId=" + this.getInventoryId() + ", sku=" + this.getSku() + ", productName=" + this.getProductName() + ", warehouseId=" + this.getWarehouseId() + ", binLocation=" + this.getBinLocation() + ", quantityOnHand=" + this.getQuantityOnHand() + ", quantityReserved=" + this.getQuantityReserved() + ", lastUpdated=" + this.getLastUpdated() + ")";
    }

    public InventoryDTO() {
    }

    public InventoryDTO(final Integer inventoryId, final String sku, final String productName, final Integer warehouseId, final String binLocation, final Integer quantityOnHand, final Integer quantityReserved, final LocalDateTime lastUpdated) {
        this.inventoryId = inventoryId;
        this.sku = sku;
        this.productName = productName;
        this.warehouseId = warehouseId;
