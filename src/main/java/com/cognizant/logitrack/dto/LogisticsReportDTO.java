...
public class LogisticsReportDTO {
    ...
    public static class LogisticsReportDTOBuilder {
        private Integer reportId;
        private String scope;
        private String metrics;
        private LocalDateTime generatedDate;

        LogisticsReportDTOBuilder() {
        }

        /**
         * @return {@code this}.
         */
        public LogisticsReportDTO.LogisticsReportDTOBuilder reportId(final Integer reportId) {
         ...
         * @return {@code this}.
         */
        public LogisticsReportDTO.LogisticsReportDTOBuilder scope(final String scope) {
            this.scope = scope;
            return this;
        }
         ...
         * @return {@code this}.
         */
        public LogisticsReportDTO.LogisticsReportDTOBuilder metrics(final String metrics) {
         ...
         * @return {@code this}.
         */
        public LogisticsReportDTO.LogisticsReportDTOBuilder generatedDate(final LocalDateTime generatedDate) {
            this.generatedDate = generatedDate;
            return this;
        }

        public LogisticsReportDTO build() {
            return new LogisticsReportDTO(this.reportId, this.scope, this.metrics, this.generatedDate);
        }

        @java.lang.Override
        public java.lang.String toString() {
            return "LogisticsReportDTO.LogisticsReportDTOBuilder(reportId=" + this.reportId + ", scope=" + this.scope + ", metrics=" + this.metrics + ", generatedDate=" + this.generatedDate + ")";
        }
    }

    public static LogisticsReportDTO.LogisticsReportDTOBuilder builder() {
        return new LogisticsReportDTO.LogisticsReportDTOBuilder();
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof LogisticsReportDTO)) return false;
        final LogisticsReportDTO other = (LogisticsReportDTO) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof LogisticsReportDTO;
    }
    ...
    @java.lang.Override
    public java.lang.String toString() {
        return "LogisticsReportDTO(reportId=" + this.getReportId() + ", scope=" + this.getScope() + ", metrics=" + this.getMetrics() + ", generatedDate=" + this.getGeneratedDate() + ")";
    }

    public LogisticsReportDTO() {
    }

    public LogisticsReportDTO(final Integer reportId, final String scope, final String metrics, final LocalDateTime generatedDate) {
        this.reportId = reportId;
        this.scope = scope;
        this.metrics = metrics;
        this.generatedDate = generatedDate;
