...
public class AuditLogDTO {
    ...
    public static class AuditLogDTOBuilder {
         ...
         * @return {@code this}.
         */
        public AuditLogDTO.AuditLogDTOBuilder auditId(final Integer auditId) {
         ...
         * @return {@code this}.
         */
        public AuditLogDTO.AuditLogDTOBuilder userId(final Integer userId) {
            this.userId = userId;
            return this;
        }
         ...
         * @return {@code this}.
         */
        public AuditLogDTO.AuditLogDTOBuilder entityId(final Integer entityId) {
         ...
         * @return {@code this}.
         */
        public AuditLogDTO.AuditLogDTOBuilder timestamp(final LocalDateTime timestamp) {
            this.timestamp = timestamp;
            return this;
        }

        public AuditLogDTO build() {
            return new AuditLogDTO(this.auditId, this.userId, this.action, this.entityType, this.entityId, this.timestamp);
        }

        @java.lang.Override
        public java.lang.String toString() {
            return "AuditLogDTO.AuditLogDTOBuilder(auditId=" + this.auditId + ", userId=" + this.userId + ", action=" + this.action + ", entityType=" + this.entityType + ", entityId=" + this.entityId + ", timestamp=" + this.timestamp + ")";
        }
    }
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (!(o instanceof AuditLogDTO)) return false;
        final AuditLogDTO other = (AuditLogDTO) o;
    ...
    protected boolean canEqual(final java.lang.Object other) {
        return other instanceof AuditLogDTO;
    }
    ...
    @java.lang.Override
    public java.lang.String toString() {
        return "AuditLogDTO(auditId=" + this.getAuditId() + ", userId=" + this.getUserId() + ", action=" + this.getAction() + ", entityType=" + this.getEntityType() + ", entityId=" + this.getEntityId() + ", timestamp=" + this.getTimestamp() + ")";
    }

    public AuditLogDTO() {
    }

    public AuditLogDTO(final Integer auditId, final Integer userId, final String action, final String entityType, final Integer entityId, final LocalDateTime timestamp) {
        this.auditId = auditId;
        this.userId = userId;
        this.action = action;
        this.entityType = entityType;
